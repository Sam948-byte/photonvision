...
public class Server {
    ...
    private static void start(int port) {
        ...
        app.get("/api/settings/photonvision_models.zip", RequestHandler::onModelsExportRequest);
        ...
        app.post("/api/utils/objectDetectionModelsImport", RequestHandler::onObjectDetectionModelsImportRequest);
